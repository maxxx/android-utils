...
//<ru.maxdestroyer.utils.view.UtilScrollView
...
//  </LinearLayout>
//  </ru.maxdestroyer.utils.view.UtilScrollView>
public class UtilScrollView extends ScrollView {
    private LinearLayout layout;
    private int maxHeight = 0;

    public UtilScrollView(Context context) {
        super(context);
        init();
    }

    public UtilScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public UtilScrollView(Context context, AttributeSet attrs, int defStyle) {
