...
public class AutoTV2 extends TextView
{
	...
	public AutoTV2(Context context) {
		this(context, null);
	}

	// Default constructor when inflating from XML file
	public AutoTV2(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	// Default constructor override
	public AutoTV2(Context context, AttributeSet attrs, int defStyle) {
